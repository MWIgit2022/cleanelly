...
#$APPLICATION->SetPageProperty("description", "Как оформить заказ на сайте Cleanelly");
...
$APPLICATION->SetPageProperty("title", "Махровые полотенца и простыни, махровые халаты, домашний текстиль Cleanelly");
