...
$APPLICATION->SetPageProperty("description", "⭐⭐⭐⭐⭐Дорожка настольная Faggio, 50х150см; цвет трюфельно-розовый; размер 50Х150 ✔️ Доступные цены на качественный текстиль для дома: полотенца, халаты, постельное белье. ✔️ Доставка по России.");
