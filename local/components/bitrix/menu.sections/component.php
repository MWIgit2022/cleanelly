	...
	else
	{
		...
		while($arSection = $rsSections->GetNext())
		{
			$arResult["SECTIONS"][] = array(
				...
				"MENU_ITEM_NAME" => $arSection["UF_MENU_ITEM"],
				"MENU_ICON" => $arSection["UF_CATALOG_ICON"],
				"HOVER_MENU_ICON"=>$arSection["UF_HOVER_ICON_MENU"]
			);
...
foreach($arResult["SECTIONS"] as $arSection)
{
	...
	$aMenuLinksNew[$menuIndex++] = array(
		...
		array(
			...
			"IS_PARENT" => false,
			"DEPTH_LEVEL" => $arSection["DEPTH_LEVEL"],
			"MENU_ITEM_NAME" => $arSection["MENU_ITEM_NAME"],
			"MENU_ICON" => $arSection["MENU_ICON"],
			"HOVER_MENU_ICON" => $arSection["HOVER_MENU_ICON"],
		),
	);
}
