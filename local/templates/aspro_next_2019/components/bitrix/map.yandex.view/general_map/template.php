...
?>
	...
	<? if (count($arResult['POSITION']['PLACEMARKS']) > 1): ?>
		var result = ymaps.geoQuery(arObjects.PLACEMARKS).applyBoundsToMap(map, {zoomMargin: 10, checkZoomRange: true});
		map.geoObjects.add(result.clusterize({zoomMargin:30}));
	<? endif; ?>
}
</script>
