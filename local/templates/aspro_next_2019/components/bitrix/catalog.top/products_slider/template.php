...
<?if($arResult["ITEMS"]):?>
	...
	<div style="position:relative;">
		<?if(strlen($arParams['TITLE'])):?>
			<h5 style="display:inline-block;"><?=$arParams['TITLE'];?></h5>
		<?endif;?>
		<ul class="slider_navigation top_big custom_flex border"></ul>
	</div>
	<div class="common_product wrapper_block" id="<?=$sliderID?>">
		<div class="all_wrapp">
			<div class="content_inner tab flexslider loading_state shadow border custom_flex top_right" data-plugin-options='{"animation": "slide", "animationSpeed": 600, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, "controlsContainer": ".slider_navigation", "counts": [4,3,3,2,1]}'>
				<ul class="tabs_slider items slides abs_img">
