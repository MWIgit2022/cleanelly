...
<script>
	$(document).ready(function() {
		$("#open_the_text").click(function() {
			$(".group_description_block").each(function(i) {
				if($(".group_description_block").hasClass('expand')) {
					$("#open_the_text").text('Развернуть')
				} else {
					$("#open_the_text").text('Скрыть')
				}
			}).toggleClass("expand");
			$(".group_description_block div:first").css({'padding-bottom': '0'});
		}) 
	});
</script>
