													...
													<div class="col-md-12 col-md-12 col-sm-12 sale-order-detail-payment-options-shipment">
														<div>
															...
															<div class="col-md-7 col-sm-7 sale-order-detail-payment-options-methods-shipment-list">
																...
																<?if($arResult['ORDER_DELIVERY_ADDRESS']['VALUE']){?>
																	<div class="sale-order-detail-payment-options-methods-shipment-list-item">
																		<?= Loc::getMessage('SPOD_ORDER_DELIVERY_ADDRESS')?>:
																		<?= htmlspecialcharsbx($arResult['ORDER_DELIVERY_ADDRESS']['VALUE'])?>
																	</div>
																<?}?>
																<?
																	if (strlen($shipment['TRACKING_NUMBER']))
																	{
																		...
																		<div class="sale-order-detail-payment-options-methods-shipment-list-item">
                                                                            ...
                                                                            <span class="sale-order-detail-shipment-id-desc">&nbsp&nbsp«Вы можете ввести его на сайте СДЭК и уточнить на каком этапе Ваш заказ»</span>
																		</div>
																		<?
																	}
																?>
																														...
																														if (isset($basketItem['PROPS']) && is_array($basketItem['PROPS']))
																														{
																															...
																															{?>
																																<div class="basket-item-property basket-item-property-scu-text" data-entity="basket-item-sku-block"> 
                                                                                                                                    <div class="basket-item-property-name"><?=$itemProps['NAME']?></div>
                                                                                                                                    <div class="basket-item-property-value">
                                                                                                                                        <ul class="basket-item-scu-list">
																																			<li class="basket-item-scu-item selected" title="<?=$itemProps['VALUE']?>" data-entity="basket-item-sku-field" data-initial="true" data-value-id="<?=$itemProps['VALUE']?>" data-sku-name="<?=$itemProps['VALUE']?>" data-property="<?=$itemProps['CODE']?>">
																																				<span class="basket-item-scu-item-inner"><?=$itemProps['VALUE']?></span>
																																			</li>
																																		</ul>
																																	</div>
																																</div>
																		...
																		if ($itemProps['VALUE']) {?>
																			<div class="sale-order-detail-order-item-color">
																				<div class="basket-item-property basket-item-property-scu-text">
																					...
																					<div class="basket-item-property-value">
																						<ul class="basket-item-scu-list">
																							<li class="basket-item-scu-item" title="<?=$itemProps['VALUE']?>" 
																								data-property="<?=$itemProps['CODE']?>">
																								<?if ($itemProps['VALUE_ENUM']) {?>
																									<span class="basket-item-scu-item-inner"><?=$itemProps['VALUE_ENUM']?></span>
																								<?} else {?>
																									<span class="basket-item-scu-item-inner"><?=$itemProps['VALUE']?></span>
																								<?}?>
																							</li>
