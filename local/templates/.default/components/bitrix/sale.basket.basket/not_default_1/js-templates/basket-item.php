			...
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						{
							?>
							<a href="javascript: void(0);" title="удалить товар из корзины" class="basket-item-actions-remove visible-xs" data-entity="basket-item-delete"></a>
							<?
						}
						?>
									...
									switch (trim((string)$blockName))
									{
										case 'props':
											if (in_array('PROPS', $arParams['COLUMNS_LIST']))
											{
												?>
												{{#PROPS}}
													<div class="basket-item-property<?=(!isset($mobileColumns['PROPS']) ? ' hidden-xs' : '')?> basket-item-property_{{CODE}}">
				...
				<div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
					...
					<div class="basket-item-amount-filed-block">
						<input type="text" class="basket-item-amount-filed" value="{{QUANTITY}}"
							...
							data-value="{{QUANTITY}}" 
							data-maxvalue="{{AVAILABLE_QUANTITY}}" 
							data-entity="basket-item-quantity-field"
							id="basket-item-quantity-{{ID}}">
							
						<div class="counter_block_ismax" style="display: none;">В наличии только {{AVAILABLE_QUANTITY}}&nbsp;товар на складе</div>
					</div>
			...
			if ($useActionColumn)
			{
				...
				<td class="basket-items-list-item-remove hidden-xs">
					<div class="basket-item-block-actions">
						<a href="javascript: void(0);" title="удалить товар из корзины" class="basket-item-actions-remove" data-entity="basket-item-delete"></a>
						{{#SHOW_LOADING}}
							<div class="basket-items-list-item-overlay"></div>
						{{/SHOW_LOADING}}
					</div>
