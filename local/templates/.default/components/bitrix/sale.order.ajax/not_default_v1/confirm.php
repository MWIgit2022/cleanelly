...
$arUser = $rsUser->Fetch();
$statuses_n_active = array(24,25,29);
if($arUser && $props_arr['DISCOUNT_CARD']['VALUE'][0]== 'Y'){?>
	<div style="display: none; width: 500px;" id="hidden">
		<?if(in_array($arUser['UF_DISCOUNT_CARD_STATUS'],$statuses_n_active) || !$arUser['UF_DISCOUNT_CARD_STATUS']){?>
			...
			<a class="resend disable" href="javascript:void(0)" onclick="reSend(this)">Отправить повторно</a>
			...
			<div class="rez"></div>
		<?} elseif($arUser['UF_DISCOUNT_CARD_STATUS'] == 28) {?>
