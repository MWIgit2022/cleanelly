...
<div id="news-list-front_akc">
<? $frame = $this->createFrame("news-list-front_akc")->begin(""); ?>
<?if($arResult["ITEMS"]){?>
	<div class="news_akc_block clearfix">
		...
		<div class="news_wrapp">
			<div class="flexslider loading_state shadow border custom_flex top_right" data-lg_count="3" data-plugin-options='{"animation": "slide", "directionNav": true, "itemMargin":30, "controlNav" :false, "animationLoop": true, "slideshow": false, "counts": [3,2,1]}'>
