...
<?else:?>
	...
	<div class="head-block top">
		...
		<?foreach($menuYear as $year):
			$bSelected = ($arResult['VARIABLES']['SECTION_CODE'] && $arResult['VARIABLES']['SECTION_CODE'] == $year['CODE']);?>
			<div class="item-link <?=($bSelected ? 'active' : '');?>">
				<div class="title btn-inline black">
					<?if($bSelected):?>
						<span class="btn-inline black"><?=$year['NAME'];?></span>
					<?else:?>
						<a class="btn-inline black" href="<?=$year['LINK'];?>"><?=$year['NAME'];?></a>
					<?endif;?>
				</div>
			</div>
		<?endforeach;?>
