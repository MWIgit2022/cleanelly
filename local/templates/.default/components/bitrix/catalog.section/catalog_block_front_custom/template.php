					...
					<div class="inner_wrap">
						<div class="image_wrapper_block shine">
							...
							<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="thumb">
								...
								<?if( !empty($arItem["PREVIEW_PICTURE"]) ):?>
									<img class="noborder lazy" data-src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
								<?elseif( !empty($arItem["DETAIL_PICTURE"])):?>
									<?$img = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], array( "width" => 500, "height" => 500 ), BX_RESIZE_IMAGE_PROPORTIONAL,true );?>
									<img class="noborder lazy" data-src="<?=$img["src"]?>" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
								<?else:?>
									<img class="noborder lazy" data-src="<?=SITE_TEMPLATE_PATH?>/images/no_photo_medium.png" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
								<?endif;?>
						...
						<div class="item_info">
							...
							<div class="cost prices clearfix">
								<?if( $arItem["OFFERS"]){?>
									<?CAsproSkuCustom::showItemPrices($arParams, $arItem, $item_id, $min_price_id, array(), 'Y');?>
								<?}else{?>
									<?
									$item_id = $arItem["ID"];
