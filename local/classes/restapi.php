	...
	class RestApi
	{
		...
		public function __construct($hook = '')
		{
			if (!empty($_REQUEST['auth'])) {
				...
				$_REQUEST['REFRESH_ID'] = $_REQUEST['auth']['refresh_token'];
			}

			$_REQUEST['DOMAIN'] = htmlspecialchars($_REQUEST['DOMAIN']);
			$_REQUEST['AUTH_ID'] = htmlspecialchars($_REQUEST['AUTH_ID']);
			$_REQUEST['REFRESH_ID'] = htmlspecialchars($_REQUEST['REFRESH_ID']);
