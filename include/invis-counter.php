...
/* window.addEventListener('scroll', () => {
    if (fired === false) {
		...
		_tmr.push({id: "3227145", type: "pageView", start: (new Date()).getTime(), pid: "USER_ID"});
		(function (d, w, id) {
		...
		!function() {
			...
			t.type="text/javascript",t.defer=!0,t.src="https://vk.com/js/api/openapi.js?168",t.onload=function() {
				VK.Retargeting.Init("VK-RTRG-499160-6jqsC"),VK.Retargeting.Hit()
			},
